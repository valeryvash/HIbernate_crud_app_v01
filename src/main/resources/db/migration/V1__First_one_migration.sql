...
create table posts_tags (post_id bigint not null, tag_id bigint not null);
...
alter table if exists posts_tags add constraint second_one foreign key (tag_id) references tags;
